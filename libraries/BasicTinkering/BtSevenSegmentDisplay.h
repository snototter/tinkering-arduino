...
//  // * Choose initial brightness in [0, 7]
//  // * Adjust delay (in microseconds) for sending bits to the I2C
//  //   5 worked nicely for my tested displays.
//  BtSevenSegmentDisplayTM1637(uint8_t pin_clk, uint8_t pin_dio,
//    uint8_t brightness = 7, unsigned long bit_delay = 5);

//  // Set the brightness in [0, 7], where 0 = off.
...
//  // Set the segments directly
//  bool setSegments(const uint8_t segments[], uint8_t num_digits = 4, uint8_t first_pos = 0);
